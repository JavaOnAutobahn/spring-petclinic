...
[[default]]
[role=group,includesGroups="maven:Default,package:Default,layer:Default,spring-component:Default,model:Default,business:Default,management:Default,test:Default,vcs:Default,codeanalysis:Default"]
- <<maven:Default>>
- <<package:Default>>
- <<layer:Default>>
